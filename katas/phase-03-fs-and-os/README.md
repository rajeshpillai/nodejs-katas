...
**Mental Model Level:** 3. Core System APIs

---

## Katas

1. [Reading and Writing Files](001-reading-and-writing-files.md)
2. [Paths and Directories](002-paths-and-directories.md)
3. [OS and System Information](003-os-and-system-info.md)
4. [Process and Environment Variables](004-process-and-environment.md)
5. [Process Lifecycle and Signals](005-process-lifecycle.md)
