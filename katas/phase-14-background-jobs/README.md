...
**Mental Model Level:** 8-10. Databases / Reliability / Performance

---

## Katas

1. [Background Workers](001-background-workers.md)
2. [Job Queues with PostgreSQL](002-job-queues.md)
3. [Retry Strategies](003-retry-strategies.md)
4. [Idempotency](004-idempotency.md)
5. [Failure Modes](005-failure-modes.md)
