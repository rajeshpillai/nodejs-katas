...
**Mental Model Level:** 9. Reliability & Observability

---

## Katas

1. [Structured Logging](001-structured-logging.md)
2. [Health Checks and Readiness Probes](002-health-checks.md)
3. [Application Metrics](003-metrics.md)
4. [Crash Handling and Recovery](004-crash-handling.md)
5. [Graceful Restart and Zero-Downtime Deploys](005-graceful-restart.md)
