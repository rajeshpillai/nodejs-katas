...
**Mental Model Level:** 1-2. Runtime & Event Loop / Asynchronous Execution

---

## Katas

1. [Event Loop Phases](001-event-loop-phases.md)
2. [libuv and the Thread Pool](002-libuv.md)
3. [Timers in Depth](003-timers.md)
4. [I/O Callbacks and the Poll Phase](004-io-callbacks.md)
5. [Worker Threads (Introduction)](005-worker-threads-intro.md)
