...
1. [URL Routing](001-routing.md)
2. [Middleware Patterns](002-middleware-patterns.md)
3. [JSON APIs and Validation](003-json-and-validation.md)
4. [Error Handling in APIs](004-error-handling.md)
5. [Graceful Shutdown](005-graceful-shutdown.md)
