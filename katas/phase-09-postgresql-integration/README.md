...
**Mental Model Level:** 8. Databases & Data Flow

---

## Katas

1. [PostgreSQL Architecture Overview](001-postgresql-architecture.md)
2. [Connection Pooling](002-connection-pooling.md)
3. [Parameterized Queries and SQL Injection](003-parameterized-queries.md)
4. [Transactions](004-transactions.md)
5. [Database Error Handling](005-error-handling-db.md)
