...
**Mental Model Level:** 6. HTTP & Web APIs

---

## Katas

1. [The HTTP Protocol](001-http-protocol.md)
2. [Headers and Content Types](002-headers-and-content-types.md)
3. [Request/Response Lifecycle](003-request-response-lifecycle.md)
4. [HTTP Keep-Alive](004-http-keep-alive.md)
5. [Content Encoding and Range Requests](005-content-encoding-and-range.md)
