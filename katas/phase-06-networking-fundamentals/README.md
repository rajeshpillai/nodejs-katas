...
**Mental Model Level:** 4. Networking & Protocols

---

## Katas

1. [TCP Basics with the net Module](001-tcp-basics.md)
2. [UDP Overview](002-udp-overview.md)
3. [Socket Lifecycle](003-socket-lifecycle.md)
4. [Timeouts and Retries](004-timeouts-and-retries.md)
5. [Length-Prefix Framing](005-length-prefix-framing.md)
