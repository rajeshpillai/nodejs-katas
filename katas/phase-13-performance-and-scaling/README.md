...
**Mental Model Level:** 10. Performance & Scaling

---

## Katas

1. [Profiling Node.js Applications](001-profiling.md)
2. [Memory Management and Leak Detection](002-memory-management.md)
3. [Event Loop Optimization](003-event-loop-optimization.md)
4. [Load Testing](004-load-testing.md)
5. [Horizontal Scaling](005-horizontal-scaling.md)
