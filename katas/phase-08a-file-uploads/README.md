...
**Mental Model Level:** 5-6. Streams / HTTP & Web APIs

---

## Katas

1. [Understanding multipart/form-data](001-multipart-form-data.md)
2. [Streaming Uploads](002-streaming-uploads.md)
3. [File Size Limits and Validation](003-file-size-limits.md)
4. [Upload Progress Tracking](004-upload-progress.md)
5. [Temporary Storage and Cleanup](005-temporary-storage.md)
