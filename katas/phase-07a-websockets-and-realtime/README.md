...
**Mental Model Level:** 7. Real-Time Systems

---

## Katas

1. [HTTP to WebSocket Upgrade](001-websocket-upgrade.md)
2. [WebSocket Frame Protocol](002-websocket-framing.md)
3. [Building a WebSocket Server](003-websocket-server.md)
4. [Real-Time State Management](004-realtime-state.md)
5. [Scaling WebSockets](005-scaling-websockets.md)
